...
export default function Config_interval_banner() {
    ...
    const validateForm = (data: FormData) => {
        ...
        if (!data.local_site && !["Pagina_inicial", "Pagina_artigo", "Pagina_todos_artigos", "Pagina_categoria", "Pagina_todas_categorias", "Pagina_sobre", "Pagina_contato"].includes(data.local_site)) {
    ...
    const onSubmit = async (data: FormData) => {
        ...
        try {
            ...
            console.log(value, value_label)

            await apiClient.post(`/marketing_publication/interval_banner`, {
                local_site: value,
                label_local_site: value_label,
                interval_banner: data.interval_banner ? String(Number(data.interval_banner)) : "0"
            });
    ...
    const handleEdit = async (id: string, field: string, value: any) => {
        ...
        try {
            ...
            if (field === "interval_banner") {
                await apiClient.put(`/marketing_publication/interval_banner/update_data?bannerInterval_id=${id}`, {
                    interval_banner: value ? String(Number(value)) : "0",
                });
            }
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        >
                            ...
                            <option value={["Pagina_artigo", "Página do artigo"]}>Página do artigo</option>
                            <option value={["Pagina_todos_artigos", "Página de todos artigos"]}>Página de todos artigos</option>
                            <option value={["Pagina_categoria", "Página de categoria"]}>Página de categoria</option>
                            <option value={["Pagina_todas_categorias", "Página de todas as categorias"]}>Página de todas as categorias</option>
                        </select>
