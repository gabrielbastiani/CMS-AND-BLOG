...
export async function generateMetadata(
    ...
    try {
        ...
        return {
            ...
            openGraph: {
                title: `Artigos de ${categoryName}`,
                description: `Descubra os melhores conteúdos sobre ${categoryName}`,
                images: [
                    {
                        url: new URL(data.image_category || "/default-category.jpg", API_URL).toString(),
                        width: 1200,
                        height: 630,
                        alt: categoryName,
                    },
